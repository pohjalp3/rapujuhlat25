...
<head>
    ...
    <meta property="og:title" content="Pohjalaisten Rapujuhlat 2025">
    <meta property="og:description" content="Vi ska dricka hela natten alkohol 😏">
    <meta property="og:image" content="https://pohjalp3.github.io/rapujuhlat25/lol.png">
    <meta property="og:url" content="https://pohjalp3.github.io/rapujuhlat25/rapujuhlat2025.html">
    ...
    <div class="container">
        ...
        <div class="contents">
            ...
            <ul>
                ...
                <li><a href="#lapinkulta-kaanon">10. Lapinkulta </a></li>
                <li><a href="#tanaan-otetaan">11. Tänään otetaan </a></li>
                <li><a href="#silja-line-special">12. Silja line special </a></li>
                <li><a href="#vi-ska-dricka-hela-natten">13. Vi ska dricka hela natten </a></li>
                <li><a href="#bittilaulu">14. Bittilaulu </a></li>
                <li><a href="#taalla-jallutahden-alla">15. Täällä jallutähden alla </a></li>
            </ul>
        </div>
...
Siis perseet sinne kääntäkää!</div>
        ...
        <div class="song" id="lapinkulta-kaanon">
            <div class="song-title">10. Lapinkulta </div>
            <div style="font-size: 16px; color: #666; text-align: center; margin-bottom: 20px; font-style: italic;">
...
kuradima kõva pohmakas. :,:</div>
        ...
        <div class="song" id="silja-line-special">
            <div class="song-title">12. Silja Line Special </div>
            <div style="font-size: 16px; color: #666; text-align: center; margin-bottom: 20px; font-style: italic;">
                (melodia: Un homme et une femme)
            </div>
           
            <div class="verse"> Tahtoisin ginitonicin, ginitonicin
 Tai sitten minttufernetin, minttufernetin.
 Kelpaisi kossuvissykin, kossuvissykin.
 Nyt ryypätään, nyt ryypätään.</div>
           
            <div class="verse"> Jos saisin ison tuopposen, ison tuopposen
 Tai sitten pullo-olusen, pullo-olusen.
 Kelpaisi tölkkikaljakin, tölkkikaljakin.
 Nyt juhlitaan, nyt juhlitaan.</div>
            ...
            <div class="back-to-top">
                ...
                <div class="song" id="vi-ska-dricka-hela-natten">
            <div class="song-title">13. Vi ska dricka hela natten </div>
            <div style="font-size: 16px; color: #666; text-align: center; margin-bottom: 20px; font-style: italic;">
                (melodia: She'll Be Coming 'Round the Mountain)
            </div>
           
            <div class="verse"> Vi ska dricka hela natten alkohol,
Vi ska dricka hela natten alkohol,
Vi ska dricka hela natten,
Vi ska dricka inte vatten,
Vi ska dricka hela natten alkohol!</div>
            ...
            <div class="back-to-top">
                <a href="#top">↑ Back to top</a>
                        ...
                        <div class="song" id="bittilaulu">
            <div class="song-title">14. Bittilaulu </div>
            <div style="font-size: 16px; color: #666; text-align: center; margin-bottom: 20px; font-style: italic;">
                (melodia: Joulupukki)
            </div>
...
10 10 1011</div>
        ...
        <div class="song" id="taalla-jallutahden-alla">
            <div class="song-title">15. Täällä jallutähden alla</div>
            <div style="font-size: 16px; color: #666; text-align: center; margin-bottom: 20px; font-style: italic;">
